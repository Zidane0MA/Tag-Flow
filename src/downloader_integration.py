...
class DownloaderIntegration:
    ...
    def __init__(self):
        self.downloader_db_path = config.DOWNLOADER_DB_PATH
    ...
    def _check_availability(self) -> bool:
        ...
        if not self.downloader_db_path:
            return False
            
        db_path = Path(self.downloader_db_path)
    ...
    def get_downloader_connection(self) -> Optional[sqlite3.Connection]:
        ...
        try:
            conn = sqlite3.connect(self.downloader_db_path)
