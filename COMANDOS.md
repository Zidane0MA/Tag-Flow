# 🔧 Sistema de Mantenimiento (`main.py`)

Este documento detalla todos los comandos disponibles a través del script `main.py`, diseñado para gestionar, mantener y verificar la integridad del ecosistema de Tag-Flow.
...
python -X utf8 main.py [COMANDO] [OPCIONES]
```
...
- **`backup`**
  ...
  - **Ejemplo:** `python -X utf8 main.py backup --compress --thumbnail-limit 50`
...
- **`list-backups`**
  ...
  - **Ejemplo:** `python -X utf8 main.py list-backups`
...
- **`verify`**
  ...
  - **Ejemplo:** `python -X utf8 main.py verify --fix-issues`
...
- **`integrity-report`**
  ...
  - **Ejemplo:** `python -X utf8 main.py integrity-report`
...
- **`regenerate-thumbnails`**
  ...
  - **Ejemplo:** `python -X utf8 main.py regenerate-thumbnails --force`
...
- **`populate-thumbnails`**
  ...
  - **Ejemplo:** `python -X utf8 main.py populate-thumbnails --platform youtube --limit 50`
...
- **`clean-thumbnails`**
  ...
  - **Ejemplo:** `python -X utf8 main.py clean-thumbnails --force`
...
- **`thumbnail-stats`**
  ...
  - **Ejemplo:** `python -X utf8 main.py thumbnail-stats`
...
- **`optimize-db`**
  ...
  - **Ejemplo:** `python -X utf8 main.py optimize-db`
...
- **`clear-db`**
  ...
  - **Ejemplo:** `python -X utf8 main.py clear-db --platform tiktok --force`
...
- **`db-stats`**
  ...
  - **Ejemplo:** `python -X utf8 main.py db-stats`
...
- **`character-stats`**
  ...
  - **Ejemplo:** `python -X utf8 main.py character-stats`
...
- **`add-character`**
  ...
  - **Ejemplo:** `python -X utf8 main.py add-character --character "Jane Doe" --game "Zenless Zone Zero" --aliases "JD" "Doe"`
...
- **`clean-false-positives`**
  ...
  - **Ejemplo:** `python -X utf8 main.py clean-false-positives`
...
- **`update-creator-mappings`**
  ...
  - **Ejemplo:** `python -X utf8 main.py update-creator-mappings`
...
- **`analyze-titles`**
  ...
  - **Ejemplo:** `python -X utf8 main.py analyze-titles --limit 1000`
...
- **`download-character-images`**
  ...
  - **Ejemplo:** `python -X utf8 main.py download-character-images --character "Firefly"`
...
- **`character-detection-report`**
  ...
  - **Opciones:**
    - `--video-ids [ID...]`: Limita el reporte a videos específicos por sus IDs.
  - **Ejemplo:** `python -X utf8 main.py character-detection-report --video-ids 1 2 3`

---

## 📹 Comandos de Procesamiento y Análisis

Los comandos de procesamiento se encargan del análisis inteligente de videos, incluyendo detección de personajes, reconocimiento musical y generación de metadatos.
...
- **Ejemplos:**
  ...
  python -X utf8 main.py process --reanalyze-video 1,2,3 --force
  ```
...
Comandos especializados para obtener información y estadísticas del sistema.

- **`show-stats`**
  - **Función:** Muestra estadísticas generales del sistema, incluyendo conteos de videos, distribución por plataformas y estado general.
  - **Ejemplo:** `python -X utf8 main.py show-stats`
